...
class User(AbstractUser):
    phone_number = PhoneNumberField(verbose_name="Номер телефону", blank=True, null=True)
    image = ProcessedImageField(verbose_name="Зображеня", upload_to="user/", null=True, blank=True)
    ...
    image_tag_thumbnail.short_description = "Аватар"
